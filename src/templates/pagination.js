...
(function () {
  const firstpages = document.getElementsByClassName('book-firstpage');
  const previouspages = document.getElementsByClassName('book-previouspage');
  const nextpages = document.getElementsByClassName('book-nextpage');
  const lastpages = document.getElementsByClassName('book-lastpage');
  const pagenums = document.getElementsByClassName('book-pagenum');
  ...
  function lastBtn() {
    ...
    this.parentNode.getElementsByClassName('book-pagenum')[0].innerText =
